  ...
  <header>
    <div class="menu" role="navigation">
      ...
      <ul>
        ...
        <li class="active"><a href="contact.php" title="Have a question or comment? Contact me!">Contact</a></li>
       </ul>
    </div>
...
?>
          ...
          <h3>Get In Touch</h3>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
            <i class="fa fa-skype"><a href="skype:daniel.coelho66?call" title="Click to call me on skype!"> daniel.coelho66</a></i>
            </div>

            <div class="col-lg-12 col-md-12 col-sm-12">
            <i class="fa fa-phone"><a href="tel:2892314990" title="Click to call me!"> 289 231 4990</a></i>
            </div>

            <div class="col-lg-12 col-md-12 col-sm-12">
            <i class="fa fa-envelope-o"><a href="mailto:danielncoelho5@hotmail.com" title="Click to send me an email!"> danielncoelho5@hotmail.com</a></i>
            </div>

            <div class="col-lg-12 col-md-12 col-sm-12">
            <i class="fa fa-map-marker"> Bradford, Ontario</i>
            </div>

            <div class="col-lg-12 col-md-12 col-sm-12">
            <a href="https://www.facebook.com/daniel.coelho.505" title="My Facebook Profile" target="_blank"><i class="fa fa-facebook-square"></i></a>
            <a href="https://ca.linkedin.com/in/danielcoelho5" target="_blank" title="My Linkedin Profile"><i class="fa fa-linkedin-square"></i></a>
            </div>
